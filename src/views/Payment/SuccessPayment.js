...
const SuccessPayment = (props)=>{
    ...
    const numberOfPeymentPage = ()=>{
        ...
        axios({
            ...
            data : {
                query : `
                    query numberOfPeymentPage($limit : Int!, $level : Int!, $success_pay : Boolean) {
                        numberOfPeymentPage(limit : $limit, level : $level, success_pay : $success_pay){
                            status,
                            message
                        }
                    }
    ...
    const getAllPayments = (pg)=>{
        ...
        axios({
            ...
            data : {
                query : `
                    query getAllPayment($page : Int, $limit : Int, $level : Int!, $success_pay : Boolean) {
                        getAllPayment(page : $page, limit : $limit, level : $level, success_pay : $success_pay){
                            _id,
