...
const SentPay = (props)=>{
    ...
    const numberOfPeymentPage = ()=>{
        ...
        axios({
            ...
            data : {
                query : `
                    query numberOfPeymentPage($limit : Int!, $level : Int!, $sent : Boolean) {
                        numberOfPeymentPage(limit : $limit, level : $level, sent : $sent){
                            status,
                            message
                        }
                    }
    ...
    const getAllPayments = (pg)=>{
        ...
        axios({
            ...
            data : {
                query : `
                    query getAllPayment($page : Int, $limit : Int, $level : Int!, $sent : Boolean) {
                        getAllPayment(page : $page, limit : $limit, level : $level, sent : $sent){
                            _id,
