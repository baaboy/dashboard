...
const CreateBannerHome = (props)=>{
    ...
    const getAllJobUserInDashboard = ({city, area})=>{
        ...
        axios({
            ...
            data : {
                query : `
                    query getAllJobUserInDashboard($page : Int!, $city : ID, $area : ID, $level : Int!) {
                        getAllJobUserInDashboard(page : $page, city : $city, area : $area, level : $level){
                            _id,
                            name,
                            last_name,
                            business_title,
    ...
    const selectionCategory = ()=>{
        if(citySelected.trim() === '' || jobUser === null || history === null){
            setError(true)
            ...
            let data = {
                query : `
                    mutation createBannerHomefromAdmin($job_user : ID!, $city : ID!, $area : ID, $history : String!, $level : Int!) {
                        createBannerHomefromAdmin(job_user : $job_user, city : $city, area : $area, history : $history, level : $level){
                            status,
                            message
                        }
                    }
