...
const AllPayments = (props)=>{
    ...
    const numberOfPeymentPage = ()=>{
        ...
        axios({
            ...
            data : {
                query : `
                    query numberOfPeymentPage($limit : Int!, $level : Int!) {
                        numberOfPeymentPage(limit : $limit, level : $level){
                            status,
                            message
                        }
                    }
    ...
    const getAllPayments = (pg)=>{
        ...
        axios({
            ...
            data : {
                query : `
                    query getAllPayment($page : Int, $limit : Int, $level : Int!) {
                        getAllPayment(page : $page, limit : $limit, level : $level){
                            _id,
