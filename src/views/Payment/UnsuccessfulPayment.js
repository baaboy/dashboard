...
const UnsuccessfulPayment = (props)=>{
    ...
    const numberOfPeymentPage = ()=>{
        ...
        axios({
            ...
            data : {
                query : `
                    query numberOfPeymentPage($limit : Int!, $level : Int!, $unsuccessful : Boolean) {
                        numberOfPeymentPage(limit : $limit, level : $level, unsuccessful : $unsuccessful){
                            status,
                            message
                        }
                    }
    ...
    const getAllPayments = (pg)=>{
        ...
        axios({
            ...
            data : {
                query : `
                    query getAllPayment($page : Int, $limit : Int, $level : Int!, $unsuccessful : Boolean) {
                        getAllPayment(page : $page, limit : $limit, level : $level, unsuccessful : $unsuccessful){
                            _id,
