...
const DeliveredPay = (props)=>{
    ...
    const numberOfPeymentPage = ()=>{
        ...
        axios({
            ...
            data : {
                query : `
                    query numberOfPeymentPage($limit : Int!, $level : Int!, $delivered : Boolean) {
                        numberOfPeymentPage(limit : $limit, level : $level, delivered : $delivered){
                            status,
                            message
                        }
                    }
    ...
    const getAllPayments = (pg)=>{
        ...
        axios({
            ...
            data : {
                query : `
                    query getAllPayment($page : Int, $limit : Int, $level : Int!, $delivered : Boolean) {
                        getAllPayment(page : $page, limit : $limit, level : $level, delivered : $delivered){
                            _id,
